...
echo $DIRNAME
if [ "$1" = "linux" ];then
docker run --rm -w $GOPATH/src/github.com/yottachain/YTDataNode/ golang go build -o ${FULLNAME} /var/lib/jenkins/workspace/YTDataNode/src/github.com/yottachain/YTDataNode/${MAINFILE}
